...
## 8. Pattern freshness (new)

- [ ] Ready-made layouts table: freshly reinstalled patterns show **"✓ Up to date"**
- [ ] Patterns installed with an older plugin build show **"✓ Installed (version unknown)"** until reinstalled once
- [ ] After a future plugin update that changes a layout: the row flips to **"⬆ Update available"** (verifiable now only by editing a layout definition locally)
