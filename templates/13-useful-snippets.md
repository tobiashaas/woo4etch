...
> **Built into the Woo4Etch plugin since 1.6.0** — a submit button `name="buy_now"` inside `form.cart` is all you need; see [`16-one-click-checkout.md`](./16-one-click-checkout.md). The snippet below remains for plugin-free setups:
