...
- **Layout install-state tracking** — the admin table now flags "Update available" when the plugin ships a newer build of an installed layout (md5 of the shipped build recorded per install; `Woo4Etch_Layouts::install_state()`).
